        ...
        <aside className="space-y-8">
            ...
            <div className="flex flex-col gap-1">
              {(["All", ...CATEGORIES] as (Category | "All")[]).map((c) => (
                <button
                  ...
                  className={cn("text-left text-sm transition", category === c ? "font-semibold text-volt" : "text-muted hover:text-ink")}
                >
                  {c}
                </button>
              ))}
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-md border border-hairline bg-white px-3 py-2 text-sm outline-none focus:border-volt"
            >
